...
Since the FreeStyle **Libre 2** glucose sensor is a Bluetooth Low Energy device and my purchase experience with the transmitters available for the previous generation has been quite frustrating, I am trying to leverage its capabilities to implement something new compared to the traditional apps:
...
<p align ="center"><br><img src="https://pbs.twimg.com/media/EnWjMbGXEAEdBxe?format=jpg&name=medium" align="top" width="50%" /></p>
<h4 align ="center">Filling the gaps from a Mac</h4>
<br><br>
